        ...
        <div class="login-card w-full max-w-md p-8 animate__animated animate__fadeIn animate__delay-1s relative overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <div class="mt-8 text-center text-xs text-gray-500">
                    <p>By continuing, you agree to our <a href="user-agreement.php" class="text-purple-400 hover:underline">Terms</a> and <a href="user-agreement.php" class="text-purple-400 hover:underline">Privacy Policy</a>.</p>
                </div>
            </div>
        </div>
    </div>
